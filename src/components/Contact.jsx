                    ...
                    <Row className="show-grid text-center">
                        ...
                        <Col xs={12} sm={4} className="person-wrapper">
                            ...
                            <ul className="contact-list fa-ul">
                                <li><i className="fas fa-map-marker-alt"></i> 123/21 First Street, Manchester, King Street, Kingston United Kingdom</li>
                                <li><i className="fas fa-phone"></i> 345-677-554</li>
                                <li><i className="fas fa-mobile-alt"></i> 323-678-567</li>
                                <li><i className="far fa-envelope"></i> info@company.com</li>
                            </ul>
                        </Col>
